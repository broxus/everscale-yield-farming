...
interface IUserData {
    ...
    function processDeposit(uint64 nonce, uint128 _amount, uint128 _accTonPerShare) external;
    ...
    function processWithdrawAll(uint128 _accTonShare, address send_gas_to) external;
}
